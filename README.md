...
Data augmentation and preprocessing (resize, flip, rotation)
...
Final optimization experiment conducted using DenseNet121 at 384×384 resolution with label smoothing and scheduled MixUp.
...
Most confusion occurs between adjacent KL grades (e.g., KL0–KL1, KL1–KL2), consistent with subtle radiographic differences.
